...
export function Footer() {
  return (
    <footer className="text-center p-4 text-surface-600 bg-surface-100 border-t border-surface-200">
      <div className="flex flex-col items-center gap-4">
        <a
          href="https://github.com/leex279/task-list-advanced"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-surface-900 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 rounded"
        >
          GitHub Repository
        </a>
        <div className="flex flex-col items-center">
          <span className="text-sm mb-2 text-surface-500">Build with</span>
          <div className="flex items-center gap-4">
            <a
              href="https://bolt.diy"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:opacity-70 transition-opacity focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 rounded"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-0.5 hover:opacity-70 transition-opacity focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 rounded"
            >
              <video
                width="32"
                height="32"
              ...
              />
              <svg
                className="h-[17px] text-surface-700"
                fill="currentColor"
                viewBox="0 0 69 13"
