      ...
      <aside>
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="link link-hover hover:opacity-90 transition-opacity"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="link link-hover flex items-center gap-0.5 hover:opacity-90 transition-opacity"
          >
            <video
              width="32"
              height="32"
              ...
              className="pointer-events-none size-8 mix-blend-lighten dark:mix-blend-darken" // Adjusted blend mode for dark theme
            />
            {/* Assuming SVG color should adapt or be neutral. If it needs to change with theme, it's more complex. */}
            <svg
              className="h-[17px] text-base-content" // Use text-base-content for theme adaptability
              fill="currentColor"
              viewBox="0 0 69 13"
